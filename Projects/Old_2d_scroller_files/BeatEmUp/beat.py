...
class DroidSprite(TwoDee.Sprite):
	def __init__(self,gameEnv,*filename):
		TwoDee.Sprite.__init__(self, gameEnv,*filename)
		self.droidSpin = False 
		self.droidCount = 0
		self.droidMaxCount = Droid.totalSpritestoUse * 6 
